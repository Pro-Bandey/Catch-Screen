let devicePixelRatio, screenWidth, screenHeight;
...
})(
  {
    ...
    d0tY: [
      function (e, t, r) {
        ...
        var n,
          a =
            (n = e("@babel/runtime/helpers/slicedToArray")) && n.__esModule
              ? n
              : { default: n };
    ...
    fbFB: [
      function (e, t, r) {
        "use strict";
        Object.defineProperty(r, "__esModule", { value: !0 }),
          (r.injectContentScriptIfNotLoaded =
            r.injectFile =
            r.checkIfContentScriptLoaded =
            r.executeCodeAsContentScript =
              void 0);
          ...
          return new Promise(function (t, r) {
            try {
              chrome.scripting.executeScript(
                { target: { tabId: e }, function: () => {} },
                function (e) {
                  return t(e);
                }
              ),
                chrome.runtime.lastError && r(chrome.runtime.lastError);
            } catch (e) {
              r(e);
            }
          });
        ...
        var l = function (e, t) {
          ...
          return new Promise(function (t) {
            ("script" === r
              ...
              : chrome.tabs.insertCSS)(e, { file: n }, function (e) {
              return t(e);
            });
          });
        };
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            (t.prev = 0), (t.next = 3), (0, o.getActiveTab)()
                          );
                        case 3:
                          return (c = t.sent), (u = c.id), (t.next = 7), s(u);
                        case 7:
                          if (((f = t.sent), !(0, a.default)(f, 1)[0])) {
                            t.next = 13;
                            break;
                          }
                        ...
                        case 15:
                          ...
                          break;
                        case 19:
                          (t.prev = 19), (t.t0 = t.catch(0)), i(t.t0);
                        case 22:
                        case "end":
                          return t.stop();
                      }
    ...
    JlD7: [
      function (e, t, r) {
        ...
        var n = f(e("@babel/runtime/regenerator")),
          a = f(e("@babel/runtime/helpers/asyncToGenerator")),
          i = f(e("@babel/runtime/helpers/slicedToArray")),
        ...
        var h,
          ...
          p = null,
          v = 0,
          g = [{ type: "script", file: "js/contentScript.js" }],
          m = (function () {
            function e(t, r) {
              (0, o.default)(this, e),
                (0, u.default)(this, "canvas", null),
                (this.width = t
                  ? t * devicePixelRatio
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    (this.canvas.width = e * devicePixelRatio),
                      (this.canvas.height = t * devicePixelRatio);
                  },
                },
                {
                  key: "drawImage",
                  value: function (e) {
                    ...
                    this.context.drawImage(
                      ...
                      h ? h * this.devicePixelRatio : p,
                      d ? d * this.devicePixelRatio : v
                    );
                  },
                },
                {
          ...
          b = function () {
            return new Promise(function (e, t) {
              try {
                chrome.tabs.captureVisibleTab({ format: "png" }, function (t) {
                  e(t);
                });
              } catch (e) {
                t(e);
          ...
          _ = function (e, t, r) {
            return new Promise(function (n, a) {
              try {
                var i = new Image();
                (i.width = t * devicePixelRatio),
                  (i.height = r * devicePixelRatio),
                  (i.onload = function () {
                    var e = new m(t, r);
                    e.drawImage({
                      image: i,
          ...
          P = async (e, t) => {
            let r;
            t && (r = !0);
            let n = e.selectedArea;
            n.top, n.left, n.width, n.height;
            await chrome.storage.local.set({ selectedArea: e.selectedArea }),
              b()
                .then(function (e) {
                  chrome.storage.local.get("selectedArea", (t) => {
                    l.getActiveTab().then((n) => {
          ...
          k = async function (e) {
            var t = e.offsetY;
            e.scrollHeight, e.windowHeight;
            (v = t), await chrome.storage.local.set({ scrollPageData: e });
          },
          L = function () {
            chrome.tabs.sendMessage(p, { action: "fullPageCapturingFinished" }),
              chrome.runtime.sendMessage({ action: "rb_hide_loader" });
          },
          R = function () {
            chrome.tabs.sendMessage(p, { action: "fullPageCapturingFailed" }),
              chrome.runtime.sendMessage({ action: "rb_hide_loader" });
          },
          T = function (e) {
            w(e, function () {
              ...
              .then(function (e) {
                ...
                (a.onload = function () {
                  ...
                  n &&
                    ((e.height = 0),
                    (e.canvasY = v),
                    (e.canvasImageHeight = v)),
                    d.drawImage(e);
                  var i = d.toDataURL();
                  if ("data:," === i) return d.reset(), (d = null), void R();
                  n
                    ? _(i, screenWidth, v)
                        .then(function (e) {
                          T(e);
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (e.prev = 0),
                            (e.next = 3),
                            (0, s.injectContentScriptIfNotLoaded)(g)
                          );
                        case 3:
                          t(), (e.next = 9);
                          break;
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (e.prev = 0), (e.next = 3), (0, l.getActiveTab)()
                          );
                        case 3:
                          (t = e.sent),
                            (r = t.id),
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 3:
                          return (
                            (t = e.sent),
                            (e.next = 6),
                            (0, s.executeCodeAsContentScript)(
                              t.id,
                              "location.href"
                            )
                          );
        ...
        chrome.runtime.lastError,
                          ...
                          case 0:
                            (e.prev = 0),
                              ...
                              (e.next =
                                "rb_select_area" === e.t0
                                  ? 4
                                  : "rb_capture_visible_area" === e.t0
                                  ? 6
                                  : "rb_capture_full_page" === e.t0
                                  ? 8
                                  : "rb_capture_selected_area" === e.t0
                                  ? 10
                                  : "rb_capture_and_copy_selected_area" === e.t0
                                  ? 12
                                  : "capture_current_viewport" === e.t0
                                  ? 14
                                  : "finish_full_page_capture" === e.t0
                                  ? 16
                                  : "forcefully_finish_full_page_capture" ===
                                    e.t0
                                  ? 18
                                  : "rb_request_access" === e.t0
                                  ? 21
                                  : 23);
                            break;
                          case 4:
                            return A(S), e.abrupt("break", 24);
                          case 6:
                            return A(x), e.abrupt("break", 24);
                          case 8:
                            return A(C), e.abrupt("break", 24);
                          case 10:
                            return P(t), e.abrupt("break", 24);
                          case 12:
                            return (
                              P(t, "copy_to_clipboard"), e.abrupt("break", 24)
                            );
                          case 14:
                            return k(t), e.abrupt("break", 24);
                          case 16:
                            return E(t), e.abrupt("break", 24);
                          case 18:
                            return (
          ...
          chrome.runtime.onMessage.addListener((e, t, r) => {
            let n = e.data;
            if ("openEditor" === e.action) w(n);
            else if ("saveToClipBoard" === e.action)
              y(function (e) {
                var t = e.id;
            ...
            else if ("rb_request_access" === e.action)
              chrome.storage.local.get((e) => {
                (devicePixelRatio = e.devicePixelRatio),
                  (screenWidth = e.screenWidth),
                  (screenHeight = e.screenHeight);
              });
            else if ("doPartOfFullPageScreenshot" === e.action) {
              const t = e.data;
              chrome.tabs.query({ active: !0 }, ([{ windowId: e, id: r }]) => {
                chrome.tabs.captureVisibleTab(
                  e,
                  { format: "jpeg", quality: 100 },
                  (e) => {
                    chrome.storage.local.get("currentImage", (n) => {
                      const a = n.currentImage || [];
                      a.push(e),
                        chrome.storage.local
                          .set({ currentImage: a })
                          .then(() => {
                            chrome.tabs.sendMessage(r || 0, {
                              action: "isDoneScreenshot",
                              data: {
                                ...t,
                                verticalAnchor: t.verticalAnchor + 1,
                              },
                            });
                          });
                    });
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if(message.action === "getData") {
        sendResponse({data: "یہ آپ کا data ہے"});
    }
    // true کا return ضروری ہے اگر response asynchronous ہے
    return true;
});
